...
if decompile then
    ...
    for k, v in pairs(scripts) do
        ...
        coroutine.resume(coroutine.create(function()
            ...
            writefile(game.PlaceId .. "/" .. v.Name .. "_" .. Count .. ".lua", decompile(v))
            Coros = Coros - 1
        end))
    ...
    writefile(game.PlaceId .. "/" .. "!info.md",
        "Decompiled " .. game.PlaceId .. ".\n" .. Count .. " scripts were decompiled.\nTook " ..
            math.floor(tick() - Time) .. " seconds.")

    print("Dumping process complete.")
end
